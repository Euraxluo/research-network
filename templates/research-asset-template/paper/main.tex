...
description, provenance manifest, Walrus snapshot, and Sui registration into one
...
workflow, licenses, and provenance needed for agents to reproduce and extend the
