...
Dataset 是证据资产。它需要声明来源、License、清洗流程、Schema、checksum、可用性和引用方式。
...
Sui 上的 Registry 是事实源，记录谁发布了什么、内容哈希、Walrus blob、父子关系、License、价格、收益分配、事件。
...
License NFT 是使用权凭证，不一定代表版权。它可以解锁付费 Skill、私有 Workflow、高级模板、商业授权、团队授权、Agent 授权。
